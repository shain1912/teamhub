...
| 2026-06-26 | 클라이언트(테넌트) 단위 격리로 확장 | 0007 마이그레이션·ClientsManager·서버 | 클라 많을 때 타 클라 프로젝트 차단. client_id를 projects/channels/profiles에 두고 게스트는 자기 client_id만(간트/스프린트는 project로 상속). 클라 격리 14/14 + 초대 5/5 검증 |
